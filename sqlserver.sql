...
---
INSERT INTO MenuItems (ItemName, ItemType, Price, TimeToMake, IsVegetarian, IsSpecial) VALUES 
("Chicken Burger", "Main", 10.00, 20, 0, 0),
("Veggie Burger", "Main", 8.00, 25, 1, 0),
("Salmon Fillet", "Main", 14.00, 15, 0, 0),
("Meatballs", "Main", 5.00, 18, 0, 0),
("Lentil Soup", "Main", 6.00, 5, 1, 0),
("NO MAIN", "Main", 0.00, 0, 1, 0), -- No main option. 
("Chips", "Side", 3.00, 8, 1),
("Salad", "Side", 4.00, 5, 1), 
